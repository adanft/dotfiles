...
- skills
- /home/dioby/.config/opencode/skills
...
### api-data-design
- Path: /home/dioby/dotfiles/skills/api-data-design/SKILL.md
- Trigger: >
- Rules:
...
### branch-pr
- Path: /home/dioby/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/dioby/.config/opencode/skills/chained-pr/SKILL.md
...
### code-quality
- Path: /home/dioby/dotfiles/skills/code-quality/SKILL.md
- Trigger: >
- Rules:
  - Pattern: Rule
...
- Path: /home/dioby/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/dioby/.config/opencode/skills/comment-writer/SKILL.md
...
### design-principles
- Path: /home/dioby/dotfiles/skills/design-principles/SKILL.md
- Trigger: >
- Rules:
  - Pattern: Rule
...
- Path: /home/dioby/dotfiles/skills/engineering-practices/SKILL.md
- Trigger: >
- Rules:
  - Pattern: Rule
...
- Path: /home/dioby/dotfiles/skills/go-api-project-structure/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: /home/dioby/.config/opencode/skills/go-testing/SKILL.md
...
### issue-creation
- Path: /home/dioby/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/dioby/.config/opencode/skills/judgment-day/SKILL.md
...
- Path: /home/dioby/dotfiles/skills/nextjs-project-structure/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### performance-reliability
- Path: /home/dioby/dotfiles/skills/performance-reliability/SKILL.md
- Trigger: >
- Rules:
  - Pattern: Rule
...
- Path: /home/dioby/dotfiles/skills/pragmatic-code-review/SKILL.md
- Trigger: >
- Rules:
  - Pattern: Rule
...
- Path: /home/dioby/dotfiles/skills/proportional-architecture/SKILL.md
- Trigger: >
- Rules:
  - Pattern: Rule
...
- Path: /home/dioby/dotfiles/skills/react-vite-project-structure/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### safe-refactoring
- Path: /home/dioby/dotfiles/skills/safe-refactoring/SKILL.md
- Trigger: >
- Rules:
  - Pattern: Rule
...
- Path: /home/dioby/dotfiles/skills/secure-error-handling/SKILL.md
- Trigger: >
- Rules:
  - Pattern: Rule
...
### skill-creator
- Path: /home/dioby/.config/opencode/skills/skill-creator/SKILL.md
...
### testing-strategy
- Path: /home/dioby/dotfiles/skills/testing-strategy/SKILL.md
- Trigger: >
- Rules:
  - Pattern: Rule
...
### work-unit-commits
- Path: /home/dioby/.config/opencode/skills/work-unit-commits/SKILL.md
